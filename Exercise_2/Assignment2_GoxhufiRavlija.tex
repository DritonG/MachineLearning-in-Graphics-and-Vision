...
\item[(f)]
Based on our plots, the logistic regression model learns something about the shoulder parts to distinguish the coat and something about the sleeves to distinguish the pullover.
